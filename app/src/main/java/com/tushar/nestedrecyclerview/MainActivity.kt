...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupRecyclerView(){
        ...
        val yourNameList= arrayListOf(R.drawable.your_name,R.drawable.your_name_2,R.drawable.your_name_3,
        ...
        val adapter= Adapter(itemList){ categoryName->
            onCategoryClicked(categoryName,demonSlayerList,yourNameList,aotList,narutoList)
        }
    ...
    private fun onCategoryClicked(
        ...
        intent.putIntegerArrayListExtra("DemonSlayerList",list)
        intent.putIntegerArrayListExtra("YourNameList",list2)
        intent.putIntegerArrayListExtra("AotList",list3)
        intent.putIntegerArrayListExtra("NarutoList",list4)
